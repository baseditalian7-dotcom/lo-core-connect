...
import {
  Users, TrendingUp, UserCheck, UserX, Search, Plus, MoreHorizontal,
} from "lucide-react";
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="mt-6 flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between"
      >
      ...
      >
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="bg-card text-xs text-muted-foreground uppercase tracking-wider">
            ...
            <tbody>
              {filtered.map((client) => (
                <tr key={client.id} className="border-t border-border/30 hover:bg-secondary/50 transition-colors">
