  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        ...
        <h1 className="text-2xl font-bold text-foreground mt-6">Entrar na sua conta</h1>
        <p className="text-sm text-muted-foreground mt-2">Insira suas credenciais para acessar o dashboard.</p>
